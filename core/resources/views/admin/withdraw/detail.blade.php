            ...
            <div class="card overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
                            @lang('Amount')
                            <span class="fw-bold">{{ showAmount($withdrawal->amount, currencyFormat: false) }} {{ __($withdrawal->currency) }}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
                            @lang('Charge')
                            <span class="fw-bold">{{ showAmount($withdrawal->charge, currencyFormat: false) }} {{ __($withdrawal->currency) }}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
                            @lang('After Charge')
                            <span class="fw-bold">{{ showAmount($withdrawal->after_charge, currencyFormat: false) }}
                                {{ __($withdrawal->currency) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center ps-0">
                            @lang('Payable')
                            <span class="fw-bold">{{ showAmount($withdrawal->final_amount, currencyFormat: false) }}
                                {{ __($withdrawal->currency) }}</span>
                        </li>
