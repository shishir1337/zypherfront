                            ...
                            <tbody>
                                @forelse($methods as $method)
                                    <tr>
                                        ...
                                        <td class="fw-bold">
                                            {{ showAmount($method->min_limit, currencyFormat: false) }} -
                                            {{ showAmount($method->max_limit, currencyFormat: false) }} {{ __($method->currency) }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                ...
                                                @if ($method->status == Status::ENABLE)
                                                    <button class="btn btn-sm btn-outline--danger ms-1 confirmationBtn" data-question="@lang('Are you sure to disable this method?')"
