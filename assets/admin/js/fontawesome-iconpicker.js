  ...
  t.prototype = {
    ...
    _createPopover: function () {
      ...
      if (!!this.options.title) {
        e.append(
          c('<div class="popover-title-text">' + this.options.title + "</div>")
        );
      }
    ...
    _createIconpicker: function () {
      ...
      for (var r in this.options.icons) {
        if (typeof this.options.icons[r].title === "string") {
          var i = a.clone();
          i.find("i").addClass(
            this.options.fullClassFormatter(this.options.icons[r].title)
          );
    ...
    _isEventInsideIconpicker: function (e) {
      ...
      if (
        (!a.hasClass("iconpicker-element") ||
          (a.hasClass("iconpicker-element") && !a.is(this.element))) &&
  ...
  t.defaultOptions = c.extend(t.defaultOptions, {
    icons: [
      ...
      },
      {
        ...
        searchTerms: ["x", "twitter", "twitter dark"],
      },
      {
        title: "lab la-500px",
        searchTerms: [],
